...
@NoArgsConstructor
@AllArgsConstructor
@JsonDeserialize(using = ComfyUITaskQueueStatus.Deserializer.class)
public class ComfyUITaskQueueStatus implements IComfyUITaskProcess {
    /**
     * 正在运行的任务
     */
    ...
    static class Deserializer extends JsonDeserializer<ComfyUITaskQueueStatus> {

        @Override
        public ComfyUITaskQueueStatus deserialize(JsonParser p, DeserializationContext context) throws IOException {
            ...
            return new ComfyUITaskQueueStatus(runningTaskIdList, pendingTaskIdList);
        }
    }
