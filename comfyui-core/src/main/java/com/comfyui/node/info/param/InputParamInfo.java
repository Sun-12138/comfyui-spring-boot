 ...
 * 节点输入信息
 */
public abstract class InputParamInfo {
     ...
     */
    public InputParamInfo(String inputName, List<String> selectList) {
     ...
     */
    public InputParamInfo(String inputName, InputParamType inputType, Object defaultValue) {
     ...
     * @param stepCount 步长
     */
    public InputParamInfo(String inputName, InputParamType inputType, Object defaultValue, Number maxValue, Number minValue, Number stepCount) {
